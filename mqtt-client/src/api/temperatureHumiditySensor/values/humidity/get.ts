...
const getTemperatureHumiditySensorHumidity: FastifyPluginAsyncTypebox = async (
  fastify,
) => {
  fastify
    .withTypeProvider<TypeBoxTypeProvider>()
    .get(
      "/humidity/:ieeeAddress/:from/:to",
...
export default getTemperatureHumiditySensorHumidity;
