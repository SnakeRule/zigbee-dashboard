...
const getSoilSensorMoisture: FastifyPluginAsyncTypebox = async (fastify) => {
  fastify
    .withTypeProvider<TypeBoxTypeProvider>()
    .get(
      "/moisture/:ieeeAddress/:from/:to",
      ...
      async (request, reply) => {
        ...
        const values = sensorValueQuery(
          fastify.db,
          SENSOR_PARAMETER.SOIL_MOISTURE,
          ieeeAddress,
...
export default getSoilSensorMoisture;
