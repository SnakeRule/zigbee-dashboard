...
const getSoilSensorIlluminance: FastifyPluginAsyncTypebox = async (fastify) => {
  fastify
    .withTypeProvider<TypeBoxTypeProvider>()
    .get(
      "/illuminance/:ieeeAddress/:from/:to",
...
export default getSoilSensorIlluminance;
